...
function groupKey(album){return monthLabel(album.sortDate||album.month||album.date||'Album')}
function share(album,event){
  event.preventDefault();event.stopPropagation();
  if(typeof window.shareFilitalia==='function')window.shareFilitalia('album',album,album.page||location.href);
}
function render(){
