const newsData = [
  {
    ...
    "image": "images/roma-u21.jpg",
    "excerpt": {
      "it": "Il torneo U21 di Roma ha messo in luce la nuova generazione del basket filippino in Italia. Tra giovani talenti, squadre emergenti e un livello sempre più competitivo, il futuro del movimento è già iniziato.",
      "en": "The Rome U21 Tournament highlighted the next generation of Filipino basketball in Italy. Rising talents, emerging teams, and a highly competitive level showed that the future of the community is already here.",
    ...
    "description": {
      "it": "Il torneo U21 di Roma ha messo in evidenza la nuova generazione del basket filippino in Italia. Tra giovani talenti, squadre emergenti e un livello sempre più competitivo, il futuro del movimento è già iniziato.",
      "en": "The Rome U21 Tournament highlighted the next generation of Filipino basketball in Italy. Rising talents, emerging teams, and an increasingly competitive level showed that the future of the community has already begun.",
      "ph": "Ipinakita ng Rome U21 Tournament ang bagong henerasyon ng Filipino basketball sa Italy. Sa mga batang talento, umuusbong na mga koponan, at patuloy na tumataas na antas ng kompetisyon, malinaw na nagsimula na ang kinabukasan ng ating komunidad."
    }
  },
{
    title: {
      it: "John Banela, il Vero MVP",
      en: "John Banela, The Real MVP",
      ph: "John Banela, Ang Tunay na MVP"
    },
    ...
    excerpt: {
      ...
      en: "FIL-ITALIA thanks John Banela for supporting and sponsoring the development of our official website.",
      ph: "Pinasasalamatan ng FIL-ITALIA si John Banela sa kanyang suporta at sponsorship sa paggawa ng aming opisyal na website."
    },

    description: {
      it: `FIL-ITALIA desidera ringraziare John Banela, programmatore informatico, per aver sostenuto e sponsorizzato la realizzazione del nostro sito ufficiale.

La sua disponibilità, le sue competenze e il suo contributo sono stati fondamentali per la crescita digitale del progetto FIL-ITALIA.
Ma chi è John Banela? È uno dei fondatori dei Nanitz Boyz di Bologna e oggi ha scelto di sposare il progetto della squadra Darat di Bologna. Un vero all-around: manager, giocatore e coach. In poche parole, mentre gli altri scelgono un ruolo, lui li ricopre praticamente tutti.
Vogliamo inoltre congratularci con lui per la vittoria del campionato CSI Élite. A causa di alcuni problemi fisici e della conseguente indisponibilità, non ha potuto ricevere i riconoscimenti di MVP della stagione e MVP delle finali. Noi, però, conosciamo bene il suo valore, le sue qualità e le sue reali potenzialità dentro e fuori dal campo.
A proposito di premi, durante un torneo Coach EJ è stato avvistato mentre sollevava con grande disinvoltura il trofeo di Best Coach. Secondo la giuria popolare, assolutamente non ufficiale ma molto rumorosa, quel premio avrebbe dovuto prenderlo John. Invitiamo quindi Coach EJ a farsi un piccolo esame di coscienza e a valutare la restituzione simbolica della coppa. In alternativa, potrebbe cavarsela offrendo una cena. Che ne dite?
Naturalmente si tratta di uno scherzo tra amici, ma una cosa è certa: il lavoro e la passione di John meritano tutto il nostro riconoscimento.
Auguriamo al signor Banela il meglio per le prossime partite e per i futuri tornei. FIL-ITALIA continuerà sicuramente a fare il tifo per lui e spera di poter collaborare nuovamente insieme in futuro.
Per noi, il vero MVP non è soltanto chi solleva un trofeo, ma anche chi mette il proprio talento a disposizione degli altri.`,

      en: `FIL-ITALIA would like to thank John Banela, an IT programmer, for supporting and sponsoring the development of our official website.

His availability, technical skills and contribution have been essential to the digital growth of the FIL-ITALIA project.
But who is John Banela? He is one of the founders of the Nanitz Boyz in Bologna and has now embraced the project of Darat Bologna. He is a true all-around figure: manager, player and coach. While most people choose one role, John seems determined to cover all of them.
We would also like to congratulate him on winning the CSI Elite Championship. Due to physical issues and his resulting unavailability, he was unable to receive the Season MVP and Finals MVP awards. However, we know his true value, qualities and potential both on and off the court.
Speaking of trophies, Coach EJ was once spotted confidently lifting a Best Coach award during a tournament. According to the completely unofficial but extremely vocal popular jury, that trophy should have gone to John. We therefore invite Coach EJ to conduct a brief examination of conscience and consider a symbolic return of the cup. Alternatively, dinner might settle the matter.
Of course, this is only a friendly joke, but one thing is certain: John’s dedication and passion deserve our full recognition.
We wish Mr. Banela the very best for his upcoming games and future tournaments. FIL-ITALIA will continue to support him and hopes to collaborate with him again in the future.
For us, the real MVP is not only the person who lifts a trophy, but also the person who uses their talent to help others`,

      ph: `Nais pasalamatan ng FIL-ITALIA si John Banela, isang IT programmer, sa kanyang suporta at sponsorship sa paggawa ng aming opisyal na website.

Malaki ang naging ambag ng kanyang oras, kaalaman at teknikal na kakayahan sa digital na paglago ng proyekto ng FIL-ITALIA.
Ngunit sino nga ba si John Banela? Isa siya sa mga founder ng Nanitz Boyz ng Bologna at ngayon ay sumusuporta na rin sa proyekto ng Darat Bologna. Isa siyang tunay na all-around: manager, player at coach. Habang ang iba ay pumipili lamang ng isang role, tila gusto niyang gawin ang lahat.
Binabati rin namin siya sa pagkapanalo sa CSI Elite Championship. Dahil sa ilang problemang pisikal at sa kanyang naging pagkawala sa ilang laro, hindi niya natanggap ang mga parangal na Season MVP at Finals MVP. Gayunpaman, alam namin ang kanyang tunay na halaga, kakayahan at potensyal sa loob at labas ng basketball court.
At dahil pinag-uusapan na rin ang mga tropeo, minsang nakita si Coach EJ na buong kumpiyansang itinataas ang Best Coach award sa isang tournament. Ayon sa hindi opisyal ngunit napakaingay na opinyon ng mga tao, para kay John dapat ang tropeong iyon. Kaya hinihikayat namin si Coach EJ na magnilay-nilay nang kaunti at pag-isipan ang simbolikong pagbabalik ng cup. Maaari rin namang isang masarap na dinner ang maging kasunduan.
Siyempre, isa lamang itong masayang biro ng magkakaibigan. Ngunit isang bagay ang sigurado: karapat-dapat kilalanin ang sipag, talento at passion ni John.
Hinihiling namin ang lahat ng tagumpay para kay Mr. Banela sa kanyang mga susunod na laro at torneo. Patuloy siyang susuportahan ng FIL-ITALIA at umaasa kaming muli kaming makikipagtulungan sa kanya sa hinaharap.
Para sa amin, ang tunay na MVP ay hindi lamang ang taong nagtataas ng tropeo, kundi pati na rin ang taong ginagamit ang kanyang talento upang makatulong sa iba.`
    }
  },
...

  {
    title: {
      ...
      ph: "Pinalalawak ng FIL-ITALIA ang Pambansang Network"
    },
