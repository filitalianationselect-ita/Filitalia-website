...
const newScript = [
  ...
  '<script src="home-gallery-full-v1.js?v=20260906-1" data-home-gallery-full-script></script>'
].join('\n');
...
if (!html.includes('home-gallery-full-v1.js?v=20260906-1') || !html.includes('home-gallery-full-v1.css?v=5')) {
