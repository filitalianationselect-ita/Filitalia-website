...
const missingFragments = requiredBridgeFragments.filter(fragment => !bridge.includes(fragment));
...
const destructive = destructivePatterns.filter(pattern => bridge.includes(pattern));
