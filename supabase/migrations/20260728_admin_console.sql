-- FIL-ITALIA Admin Console
-- Run once in Supabase SQL Editor before enabling real persistence.
...
-- OAuth connection writes are performed only by Edge Functions with service-role access.
